    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'email' => [
                'required',
                'email',
                Rule::unique('employees')->where('location_id', $this->location_id)->ignore($employee->id),
            ],
            ...
            'aadhaar' => [
                'nullable',
                'regex:/^[0-9]{12}$/',
                Rule::unique('employees', 'aadhaar')->ignore($employee->id),
            ],
            'pan' => [
                'nullable',
                'regex:/^[A-Z]{5}[0-9]{4}[A-Z]{1}$/',
                Rule::unique('employees', 'pan')->ignore($employee->id),
            ],
